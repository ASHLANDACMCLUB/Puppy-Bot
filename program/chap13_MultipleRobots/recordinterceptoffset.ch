...
double speed1=1.5, speed2=2; // speeds of robots in inches per second
double radius1=1.1, radius2=1.1; // the radii of two wheels of robot1 and robot2
double offset=17;            // the offset for the distance of robot1
double time1=6, time2=4;     // motion time in seconds for robot1 and robot2
...
/* robot1 drives backward first for a total of 'time1' seconds.
